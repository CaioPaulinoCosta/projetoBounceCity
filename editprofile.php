...
?>
<div id="main-container" class="container-fluid" style="background-image: url('img/backgroundEditprofile.png')">
    <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lastname" name="lastname"
                                placeholder="Digite seu sobrenome" value="<?= $userData->lastname ?>" maxlength="20">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="bio" name="bio" rows="5"
                                    placeholder="Conte quem você é, o que faz, onde joga basquete..."><?= $userData->bio ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
